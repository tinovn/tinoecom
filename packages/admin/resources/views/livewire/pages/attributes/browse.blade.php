...
<x-tinoecom::container class="py-5">
    ...
    <x-tinoecom::heading class="mt-5" :title="__('tinoecom::pages/attributes.menu')">
        <x-slot name="action">
            @if ($total > 0)
                @can('add_attributes')
                    <div class="flex space-x-3">
                        <span class="rounded-md shadow-sm">
                            <x-tinoecom::buttons.primary
                                wire:click="$dispatch('openPanel', { component: 'tinoecom-slide-overs.attribute-form' })"
                                type="button"
                            >
                                {{ __('tinoecom::forms.actions.create') }}
                            </x-tinoecom::buttons.primary>
                        </span>
                    </div>
                @endcan
    ...
    @if ($total === 0)
        <x-tinoecom::empty-state
            :title="__('tinoecom::pages/attributes.title')"
            :content="__('tinoecom::pages/attributes.content')"
            :button="__('tinoecom::pages/attributes.add')"
            permission="add_attributes"
            panel="{ component: 'tinoecom-slide-overs.attribute-form' }"
        >
            <div class="shrink-0">
                <svg class="h-64 w-auto lg:h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 250">
                    <style>
                        .st1 {
                            fill: #263238;
                        }
                    ...
                    <path
                        d="M294.9 90.3c-3.4-25-5.7-43.6-16.6-56.3-10.9-12.7-26.6-21.3-49.6-21.7-25-.5-38.9 16.7-47.6 31-11 17.9-7.1 43.4-21.8 58.4-8.5 8.8-21.3 11.7-33.4 13.3-12.1 1.6-24.7 2.2-35.6 7.8C70 133.3 61.2 160 67.9 181.9c6.7 21.9 26.3 38.3 48.1 45.2 21.8 6.9 62.3 15.4 84.6 10.3 33.8-2.9 64.1-22.6 79.8-52.7 1.1-2 2.1-4.1 3-6.1 12.2-27.1 15.5-58.8 11.5-88.3z"
                        fill="#e1effe"
                        id="Background_Simple"
                    />
                    <path
                        class="st1"
                        d="M310.5 250.3c0 .1-67.9.2-151.7.2-83.8 0-151.7-.1-151.7-.2s67.9-.2 151.7-.2c83.8.1 151.7.1 151.7.2z"
                        id="Desk"
                    />
                    <g id="Features">
                        ...
                        <path
                            d="M228.1 122.8h.5v3h-.5v-3zm1.8 0h.5v1.6h-.5v-1.6zm1.9 0h.5v3h-.5v-3zm1.8 0h.5v1.6h-.5v-1.6zm1.9 0h.5v3h-.5v-3zm1.8 0h.5v1.6h-.5v-1.6zm1.9 0h.5v3h-.5v-3zm1.8 0h.5v1.6h-.5v-1.6zm1.9 0h.5v3h-.5v-3zm1.7 0h.5v1.6h-.5v-1.6zm2 0h.5v3h-.5v-3zm1.7 0h.5v1.6h-.5v-1.6zm2 0h.5v3h-.5v-3zm1.7 0h.5v1.6h-.5v-1.6zm2 0h.5v3h-.5v-3z"
                            fill="#4d5c7d"
                        />
                        <ellipse cx="228.2" cy="118.6" rx="9.3" ry="3" fill="#f7be56" />
                        <ellipse cx="228.2" cy="118.6" rx="5.4" ry="1.7" fill="#dc8744" />
                        <path
                            d="M259.3 121.4h-3c-.2 0-.4.2-.5.4-.7 2.8-.7 5.4 0 7.9.1.2.3.4.5.4h3c.3 0 .6-.3.6-.6V122c0-.4-.2-.6-.6-.6zm-2.1 5.3c0 .2-.2.4-.4.4s-.4-.2-.4-.4v-2.1c0-.2.2-.4.4-.4s.4.2.4.4v2.1z"
                            fill="#ebf0f3"
                        />
                        <path
                            class="st2"
                            d="M121.8 152.3c-.1-.1.4-.6 1.1-1.2.7-.6 1.3-1 1.4-.9.1.1-.4.6-1.1 1.2-.7.5-1.3.9-1.4.9zm-4.9 4.1c-.1-.1.4-.6 1.1-1.2.7-.6 1.3-1 1.4-.9.1.1-.4.6-1.1 1.2-.8.6-1.4 1-1.4.9zm-5 4.2c-.1-.1.4-.6 1.1-1.2.7-.6 1.3-1 1.4-.9.1.1-.4.6-1.1 1.2-.7.5-1.3.9-1.4.9zm-5 4.1c-.1-.1.4-.6 1.1-1.2.7-.6 1.3-1 1.4-.9.1.1-.4.6-1.1 1.2-.7.6-1.3 1-1.4.9zm-4.9 4.2c-.1-.1.4-.6 1.1-1.2.7-.6 1.3-1 1.4-.9.1.1-.4.6-1.1 1.2-.8.5-1.4.9-1.4.9z"
                        />
                        <ellipse class="st5" cx="84" cy="191.1" rx="29.4" ry="27.4" />
                        <path
                            class="st2"
                            d="M113.4 191.1v-.4c0-.3 0-.7-.1-1.3 0-.3 0-.6-.1-1 0-.4-.1-.7-.2-1.1-.1-.4-.1-.9-.2-1.3-.1-.5-.3-1-.4-1.5-.5-2.1-1.6-4.6-3.3-7.3-1.7-2.6-4.1-5.4-7.5-7.7-.4-.3-.8-.6-1.3-.9-.4-.3-.9-.5-1.4-.8-.5-.3-.9-.6-1.4-.8-.5-.2-1-.5-1.5-.7-.3-.1-.5-.2-.8-.3-.3-.1-.5-.2-.8-.3-.5-.2-1.1-.4-1.6-.6-.6-.2-1.1-.3-1.7-.4-.6-.1-1.2-.3-1.8-.4-1.2-.2-2.4-.4-3.7-.4-.6 0-1.3-.1-1.9-.1-.6 0-1.3.1-1.9.1-.3 0-.7 0-1 .1-.3 0-.6.1-1 .1-.7.1-1.3.2-2 .3-1.3.3-2.6.6-3.9 1.1-1.3.4-2.5 1-3.8 1.6-.6.3-1.2.7-1.8 1-.3.2-.6.3-.9.5l-.9.6c-1.2.8-2.2 1.7-3.3 2.6l-1.5 1.5-.4.4-.3.4-.7.8-.7.8-.6.9-.6.9-.3.5-.3.5c-.3.6-.7 1.3-1 1.9-.3.7-.5 1.3-.8 2-1 2.7-1.5 5.6-1.5 8.6s.6 5.9 1.5 8.6c.3.7.5 1.3.8 2 .3.6.7 1.3 1 1.9l.2.5.3.5.6.9.6.9.7.8.7.8.3.4.4.4 1.5 1.5c1.1.9 2.1 1.9 3.3 2.6l.9.6c.3.2.6.4.9.5.6.3 1.2.7 1.8 1 1.3.6 2.5 1.2 3.8 1.6 1.3.5 2.6.7 3.9 1.1.7.1 1.3.2 2 .3.3 0 .7.1 1 .1.3 0 .7 0 1 .1.7 0 1.3.1 1.9.1.6 0 1.3 0 1.9-.1 1.3 0 2.5-.2 3.7-.4.6-.1 1.2-.3 1.8-.4.6-.1 1.2-.3 1.7-.4.6-.2 1.1-.4 1.6-.6.3-.1.5-.2.8-.3.3-.1.5-.2.8-.3.5-.2 1-.5 1.5-.7.5-.2 1-.5 1.4-.8.5-.3.9-.5 1.4-.8.4-.3.8-.6 1.3-.9 3.3-2.3 5.8-5.1 7.5-7.7 1.7-2.6 2.7-5.1 3.3-7.3.1-.5.3-1 .4-1.5.1-.5.2-.9.2-1.3.1-.4.1-.8.2-1.1 0-.4 0-.7.1-1 0-.6.1-1 .1-1.3.1-.1.1-.2.1-.2v.4c0 .3 0 .7-.1 1.3v1c0 .4-.1.7-.2 1.1-.1.4-.1.9-.2 1.3-.1.5-.2 1-.4 1.5-.5 2.1-1.5 4.6-3.2 7.3-1.7 2.7-4.1 5.5-7.5 7.8-.4.3-.8.6-1.3.9-.4.3-.9.5-1.4.8-.5.3-.9.6-1.4.8-.5.2-1 .5-1.5.7-.3.1-.5.2-.8.3-.3.1-.5.2-.8.3-.5.2-1.1.4-1.7.6-.6.2-1.2.3-1.7.4-.6.1-1.2.3-1.8.4-1.2.2-2.5.4-3.7.4-.6 0-1.3.1-1.9.1-.6 0-1.3-.1-2-.1-.3 0-.7 0-1-.1-.3 0-.7-.1-1-.1-.7-.1-1.3-.2-2-.3-1.3-.3-2.7-.6-3.9-1.1-1.3-.4-2.6-1-3.9-1.6-.6-.3-1.2-.7-1.8-1-.3-.2-.6-.3-.9-.5l-.9-.6c-1.2-.8-2.3-1.7-3.4-2.7l-1.5-1.5-.4-.4-.3-.4-.7-.8-.7-.8-.6-.9-.6-.9-.3-.5-.3-.5c-.3-.6-.7-1.3-1-1.9-.3-.7-.5-1.4-.8-2-1-2.8-1.5-5.7-1.5-8.7 0-3 .6-5.9 1.5-8.7.3-.7.5-1.4.8-2 .3-.6.7-1.3 1-1.9l.3-.5.3-.5.6-.9.6-.9.7-.8.7-.8.3-.4.4-.4 1.5-1.5c1.1-.9 2.2-1.9 3.4-2.7l.9-.6c.3-.2.6-.4.9-.5.6-.3 1.2-.7 1.8-1 1.3-.6 2.5-1.2 3.9-1.6 1.3-.5 2.6-.7 3.9-1.1.7-.1 1.3-.2 2-.3.3 0 .7-.1 1-.1.3 0 .7 0 1-.1.7 0 1.3-.1 2-.1.6 0 1.3.1 1.9.1 1.3 0 2.5.2 3.7.4.6.1 1.2.3 1.8.4.6.1 1.2.3 1.7.4.6.2 1.1.4 1.7.6.3.1.5.2.8.3.3.1.5.2.8.3.5.2 1 .5 1.5.7.5.2 1 .5 1.4.8.5.3.9.5 1.4.8.4.3.9.6 1.3.9 3.3 2.4 5.8 5.2 7.5 7.8 1.7 2.7 2.7 5.2 3.2 7.3.1.5.3 1 .4 1.5.1.5.1.9.2 1.3s.1.8.2 1.1v1c0 .6 0 1 .1 1.3v.4z"
                        />
                        <path
                            class="st6"
                            d="M89 199.3c-.3-.3-.8-.3-1.1 0l-2.8 2.8v-20.5l2.8 2.9c.1.1.3.2.5.2s.4-.1.6-.2l.4-.4c.1-.1.2-.3.2-.6 0-.2-.1-.4-.2-.6l-4.9-4.9c-.2-.2-.4-.2-.6-.2-.2 0-.4.1-.6.2l-4.9 4.9c-.3.3-.3.8 0 1.1l.4.4c.3.3.8.3 1.1 0l2.8-2.8v20.3l-2.8-2.8c-.3-.3-.8-.3-1.1 0l-.4.4c-.3.3-.3.8 0 1.1l4.9 4.9c.2.2.4.2.6.2.2 0 .4-.1.6-.2l4.9-4.9c.3-.3.3-.8 0-1.1l-.4-.2z"
                        />
                        <path
                            class="st2"
                            d="M158.6 153.5c-.1 0-.5-.6-.9-1.4-.4-.8-.6-1.5-.6-1.5.1 0 .5.6.9 1.4.4.7.7 1.4.6 1.5zm2.8 5.8c-.1 0-.5-.6-.9-1.4-.4-.8-.6-1.5-.6-1.5.1 0 .5.6.9 1.4.4.8.7 1.5.6 1.5zm2.8 5.8c-.1 0-.5-.6-.9-1.4-.4-.8-.6-1.5-.6-1.5.1 0 .5.6.9 1.4.4.8.7 1.5.6 1.5zm2.8 5.9c-.1 0-.5-.6-.9-1.4-.4-.8-.6-1.5-.6-1.5.1 0 .5.6.9 1.4.5.7.7 1.4.6 1.5zm2.9 5.8c-.1 0-.5-.6-.9-1.4-.4-.8-.6-1.5-.6-1.5.1 0 .5.6.9 1.4.4.8.6 1.5.6 1.5z"
                        />
                        <ellipse class="st5" cx="175.7" cy="202.6" rx="29.4" ry="27.4" />
                        <path
                            class="st2"
                            d="M205.1 202.6v-.4c0-.3 0-.7-.1-1.3 0-.3 0-.6-.1-1 0-.4-.1-.7-.2-1.1-.1-.4-.1-.9-.2-1.3-.1-.5-.3-1-.4-1.5-.5-2.1-1.6-4.6-3.3-7.3-1.7-2.6-4.1-5.4-7.5-7.7-.4-.3-.8-.6-1.3-.9-.4-.3-.9-.5-1.4-.8-.5-.3-.9-.6-1.4-.8-.5-.2-1-.5-1.5-.7-.3-.1-.5-.2-.8-.3-.3-.1-.5-.2-.8-.3-.5-.2-1.1-.4-1.6-.6-.6-.2-1.1-.3-1.7-.4-.6-.1-1.2-.3-1.8-.4-1.2-.2-2.4-.4-3.7-.4-.6 0-1.3-.1-1.9-.1-.6 0-1.3.1-1.9.1-.3 0-.7 0-1 .1-.3 0-.6.1-1 .1-.7.1-1.3.2-2 .3-1.3.3-2.6.6-3.9 1.1-1.3.4-2.5 1-3.8 1.6-.6.3-1.2.7-1.8 1-.3.2-.6.3-.9.5l-.9.6c-1.2.8-2.2 1.7-3.3 2.6l-1.5 1.5-.4.4-.3.4-.7.8-.7.8-.6.9-.6.9-.3.5-.3.5c-.3.6-.7 1.3-1 1.9-.3.7-.5 1.3-.8 2-1 2.7-1.5 5.6-1.5 8.6s.6 5.9 1.5 8.6c.3.7.5 1.3.8 2 .3.6.7 1.3 1 1.9l.2.5.3.5.6.9.6.9.7.8.7.8.3.4.4.4 1.5 1.5c1.1.9 2.1 1.9 3.3 2.6l.9.6c.3.2.6.4.9.5.6.3 1.2.7 1.8 1 1.3.6 2.5 1.2 3.8 1.6 1.3.5 2.6.7 3.9 1.1.7.1 1.3.2 2 .3.3 0 .7.1 1 .1.3 0 .7 0 1 .1.7 0 1.3.1 1.9.1.6 0 1.3 0 1.9-.1 1.3 0 2.5-.2 3.7-.4.6-.1 1.2-.3 1.8-.4.6-.1 1.2-.3 1.7-.4.6-.2 1.1-.4 1.6-.6.3-.1.5-.2.8-.3.3-.1.5-.2.8-.3.5-.2 1-.5 1.5-.7.5-.2 1-.5 1.4-.8.5-.3.9-.5 1.4-.8.4-.3.8-.6 1.3-.9 3.3-2.3 5.8-5.1 7.5-7.7 1.7-2.6 2.7-5.1 3.3-7.3.1-.5.3-1 .4-1.5.1-.5.2-.9.2-1.3.1-.4.1-.8.2-1.1 0-.4 0-.7.1-1 0-.6.1-1 .1-1.3.1-.1.1-.2.1-.2v.4c0 .3 0 .7-.1 1.3v1c0 .4-.1.7-.2 1.1-.1.4-.1.9-.2 1.3-.1.5-.2 1-.4 1.5-.5 2.1-1.5 4.6-3.2 7.3-1.7 2.7-4.1 5.5-7.5 7.8-.4.3-.8.6-1.3.9-.4.3-.9.5-1.4.8-.5.3-.9.6-1.4.8-.5.2-1 .5-1.5.7-.3.1-.5.2-.8.3-.3.1-.5.2-.8.3-.5.2-1.1.4-1.7.6-.6.2-1.2.3-1.7.4-.6.1-1.2.3-1.8.4-1.2.2-2.5.4-3.7.4-.6 0-1.3.1-1.9.1-.6 0-1.3-.1-2-.1-.3 0-.7 0-1-.1-.3 0-.7-.1-1-.1-.7-.1-1.3-.2-2-.3-1.3-.3-2.7-.6-3.9-1.1-1.3-.4-2.6-1-3.9-1.6-.6-.3-1.2-.7-1.8-1-.3-.2-.6-.3-.9-.5l-.9-.6c-1.2-.8-2.3-1.7-3.4-2.7l-1.5-1.5-.4-.4-.3-.4-.7-.8-.7-.8-.6-.9-.6-.9-.3-.5-.3-.5c-.3-.6-.7-1.3-1-1.9-.3-.7-.5-1.4-.8-2-1-2.8-1.5-5.7-1.5-8.7 0-3 .6-5.9 1.5-8.7.3-.7.5-1.4.8-2 .3-.6.7-1.3 1-1.9l.3-.5.3-.5.6-.9.6-.9.7-.8.7-.8.3-.4.4-.4 1.5-1.5c1.1-.9 2.2-1.9 3.4-2.7l.9-.6c.3-.2.6-.4.9-.5.6-.3 1.2-.7 1.8-1 1.3-.6 2.5-1.2 3.9-1.6 1.3-.5 2.6-.7 3.9-1.1.7-.1 1.3-.2 2-.3.3 0 .7-.1 1-.1.3 0 .7 0 1-.1.7 0 1.3-.1 2-.1.6 0 1.3.1 1.9.1 1.3 0 2.5.2 3.7.4.6.1 1.2.3 1.8.4.6.1 1.2.3 1.7.4.6.2 1.1.4 1.7.6.3.1.5.2.8.3.3.1.5.2.8.3.5.2 1 .5 1.5.7.5.2 1 .5 1.4.8.5.3.9.5 1.4.8.4.3.9.6 1.3.9 3.3 2.4 5.8 5.2 7.5 7.8 1.7 2.7 2.7 5.2 3.2 7.3.1.5.3 1 .4 1.5.1.5.1.9.2 1.3s.1.8.2 1.1v1c0 .6 0 1 .1 1.3v.4z"
                        />
                        <linearGradient
                            id="SVGID_1_"
                        ...
                        <path
                            d="M61.6 115.3H65c0 2.9-1.2 5.6-3.1 7.5l-2.4-2.4c1.3-1.3 2.1-3.1 2.1-5.1z"
                            fill="#8cc152"
                        />
                        <path
                            d="M61.9 122.8c-1.9 1.9-4.6 3.1-7.5 3.1v-3.4c2 0 3.8-.8 5.1-2.1l2.4 2.4z"
                            fill="#37bc9b"
                        />
                        <path
                            d="M61.9 107.7l-2.4 2.4c-1.3-1.3-3.1-2.1-5.1-2.1v-3.4c2.9 0 5.6 1.2 7.5 3.1z"
                            fill="#e9573f"
                        />
                        ...
                        <path
                            d="M54.3 122.5v3.4c-2.9 0-5.6-1.2-7.5-3.1l2.4-2.4c1.3 1.3 3.2 2.1 5.1 2.1z"
                            fill="#4a89dc"
                        />
                        ...
                        <path
                            d="M49.2 120.4l-2.4 2.4c-1.9-1.9-3.1-4.6-3.1-7.5h3.4c0 2 .8 3.8 2.1 5.1z"
                            fill="#967adc"
                        />
                        ...
                        <path
                            d="M46.8 107.7l2.4 2.4c-1.3 1.3-2.1 3.1-2.1 5.1h-3.4c0-2.9 1.2-5.5 3.1-7.5z"
                            fill="#d770ad"
                        />
                        <path
                            d="M59.5 110.2l-2.4 2.4c-.7-.7-1.6-1.1-2.7-1.1v-3.4c1.9 0 3.8.8 5.1 2.1z"
                            fill="#fc6e51"
                        />
    ...
    <x-tinoecom::learn-more :name="__('tinoecom::pages/attributes.menu')" link="attributes" />
