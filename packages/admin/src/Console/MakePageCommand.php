...
#[AsCommand(name: 'make:tinoecom-page')]
class MakePageCommand extends FileManipulationCommand
{
    protected $signature = 'make:tinoecom-page {name?} {--f|force}';

    protected $description = 'Create a new Tinoecom page class and view';
    ...
    public function handle(): void
    {
        ...
        $parser = new ComponentParser(
            classNamespace: config('tinoecom.admin.pages.namespace'),
            viewPath: config('tinoecom.admin.pages.view_path'),
            rawCommand: $page
        );
        ...
        if ($view || $class) {
            $this->components->info('Tinoecom Page Created 🚀');
