...
use Tinoecom\Traits\CanBeCacheable;

class IconPicker extends Select
{
    use CanBeCacheable;

    protected string $view = 'tinoecom::filament.form.icon-picker';
    ...
    public function setUp(): void
    {
        ...
        $this
            ->itemTemplate(fn (IconPicker $component, string $icon) => view('tinoecom::filament.icon-picker-item', [
                'icon' => $icon,
            ])->render())
            ->placeholder(__('tinoecom::forms.placeholder.icon_placeholder'));
    }
