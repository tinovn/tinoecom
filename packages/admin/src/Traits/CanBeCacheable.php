...
trait CanBeCacheable
{
    ...
    {
        $cacheable = $this->cacheable ?? config('tinoecom.admin.icon-picker.cache', true);
    ...
    {
        $duration = $this->cacheDuration ?? now()->add(config('tinoecom.admin.icon-picker.duration', '7 days'));
