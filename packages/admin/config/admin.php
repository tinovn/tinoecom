...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | You may change the domain where Tinoecom should be active. If the domain
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the namespace and directory that Tinoecom save page components
    |
    */

    'pages' => [
        'namespace' => 'App\\Livewire\\Tinoecom',
        'view_path' => resource_path('views/livewire/tinoecom'),
    ],
